...
// Merrni baret në Elbasan
$sql = "SELECT * FROM facilities WHERE type = 'bar' AND city = 'Elbasan'";
...
<body>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Baret në Elbasan</h1>
        ...
        <?php else: ?>
            <p>Asnjë bar nuk u gjet në Elbasan.</p>
        <?php endif; ?>
    </div>
