...
// Merrni baret në Berat
$sql = "SELECT * FROM facilities WHERE type = 'bar' AND city = 'Berat'";
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Udhëzuesi për Berat</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="barstirana.php">Bar në Tiranë</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="hotelsTirana.php">Hotelet në Tiranë</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="restaurantsTirana.php">Restorantet në Tiranë</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="barsBerat.php">Baret në Berat</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Baret në Berat</h1>
                ...
                <div class="carousel-inner">
                    <?php foreach ($bars as $index => $bar): ?>
                        <div class="carousel-item <?php echo $index === 0 ? 'active' : ''; ?>">
                            <a href="<?php echo htmlspecialchars($bar['booking_url']); ?>" target="_blank">
        ...
        <?php else: ?>
            <p>Asnjë bar nuk u gjet në Berat.</p>
        <?php endif; ?>
    </div>
