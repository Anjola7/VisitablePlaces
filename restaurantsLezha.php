...
// Merrni restorantet në Lezhë
$sql = "SELECT * FROM facilities WHERE type = 'restaurant' AND city = 'Lezhe'";
...
<head>
    ...
    <title>Restorantet në Lezhë</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="bartirane.php">Bar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="hotelsLezhe.php">Hotelet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="restaurantsLezhe.php">Restorantet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="taxisLezhe.php">Taksitë</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Restorantet në Lezhë</h1>
        ...
        <?php else: ?>
            <p>Asnjë restorant nuk u gjet në Lezhë.</p>
        <?php endif; ?>
    </div>
