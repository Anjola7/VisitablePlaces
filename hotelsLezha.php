...
// Merrni hotelet në Lezhë
$sql = "SELECT * FROM facilities WHERE type = 'hotel' AND city = 'Lezhe'";
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Udhëzuesi për Lezhën</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="barsLezha.php">Bar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="hotelsLezha.php">Hotelet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="restaurantsLezha.php">Restorantet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="taxisLezha.php">Taksitë</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Hotelet në Lezhë</h1>
        ...
        <?php else: ?>
            <p>Asnjë hotel nuk u gjet në Lezhë.</p>
        <?php endif; ?>
    </div>
