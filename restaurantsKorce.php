...
// Merrni restorantet në Korçë
$sql = "SELECT * FROM facilities WHERE type = 'restaurant' AND city = 'Korce'";
...
<head>
    ...
    <title>Restorantet në Korçë</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="restaurantsKorce.php">Restorantet</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Restorantet në Korçë</h1>
        ...
        <?php else: ?>
            <p>Asnjë restorant nuk u gjet në Korçë.</p>
        <?php endif; ?>
    </div>
