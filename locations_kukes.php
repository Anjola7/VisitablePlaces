...
// Marrja e të gjitha vendndodhjeve që janë të lidhura me Kukësin
$query = "SELECT * FROM locations WHERE location_city = 'Kukes'";
...
<head>
    ...
    <title>Locations in Kukës</title>
