...
// Marrja e të gjitha vendndodhjeve që janë të lidhura me Shkodrën
$query = "SELECT * FROM locations WHERE location_city = 'Shkoder'";
...
<head>
    ...
    <title>Locations in Shkoder</title>
