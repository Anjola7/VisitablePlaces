...
// Merrni hotelet në Durrës
$sql = "SELECT * FROM facilities WHERE type = 'hotel' AND city = 'Durres'";
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="barsDurres.php">Bar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="hotelsDurres.php">Hotelet</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Hotelet në Durrës</h1>
        ...
        <?php else: ?>
            <p>Asnjë hotel nuk u gjet në Durrës.</p>
        <?php endif; ?>
    </div>
