...
// Merrni baret në Diber
$sql = "SELECT * FROM facilities WHERE type = 'bar' AND city = 'Diber'";
...
<body>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Baret në Diber</h1>
        ...
        <?php else: ?>
            <p>Asnjë bar nuk u gjet në Diber.</p>
        <?php endif; ?>
    </div>
