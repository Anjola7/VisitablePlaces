...
// Merrni restorantet në Dibrën
$sql = "SELECT * FROM facilities WHERE type = 'restaurant' AND city = 'Diber'";
...
<head>
    ...
    <title>Restorantet në Diber</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="restaurantsDiber.php">Restorantet</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Restorantet në Diber</h1>
        ...
        <?php else: ?>
            <p>Asnjë restorant nuk u gjet në Diber.</p>
        <?php endif; ?>
    </div>
