...
// Merrni taksitë në Elbasan
$sql = "SELECT * FROM facilities WHERE type = 'taxi' AND city = 'Elbasan'";
...
<head>
    ...
    <title>Taksitë në Elbasan</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="barElbasan.php">Bar</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="taxiElbasan.php">Taksitë</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Taksitë në Elbasan</h1>
        ...
        <?php else: ?>
            <p>Asnjë taksi nuk u gjet në Elbasan.</p>
        <?php endif; ?>
    </div>
