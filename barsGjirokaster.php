...
$sql = "SELECT * FROM facilities WHERE type = 'bar' AND city = 'Gjirokaster'";
...
<head>
    ...
    <title>Baret në Gjirokaster</title>
...
<body>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Baret në Gjirokaster</h1>
        ...
        <?php else: ?>
            <p>Asnjë bar nuk u gjet në Gjirokaster.</p>
        <?php endif; ?>
    </div>
