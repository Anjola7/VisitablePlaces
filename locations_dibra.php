...
// Marrja e të gjitha vendndodhjeve që janë të lidhura me Dibrën
$query = "SELECT * FROM locations WHERE location_city = 'Diber'";
...
<head>
    ...
    <title>Locations in Dibra</title>
