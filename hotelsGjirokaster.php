...
// Merrni hotelet në Gjirokastër
$sql = "SELECT * FROM facilities WHERE type = 'hotel' AND city = 'Gjirokaster'";
...
<head>
    ...
    <title>Hotelet në Gjirokastër</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="hotelsGjirokaster.php">Hotelet</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Hotelet në Gjirokastër</h1>
        ...
        <?php else: ?>
            <p>Asnjë hotel nuk u gjet në Gjirokastër.</p>
        <?php endif; ?>
    </div>
