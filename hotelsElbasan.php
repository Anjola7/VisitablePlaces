...
// Merrni hotelet në Elbasan
$sql = "SELECT * FROM facilities WHERE type = 'hotel' AND city = 'Elbasan'";
...
<head>
    ...
    <title>Hotelet në Elbasan</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="hotelsElbasan.php">Hotelet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="restaurantsElbasan.php">Restorantet</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Hotelet në Elbasan</h1>
        ...
        <?php else: ?>
            <p>Asnjë hotel nuk u gjet në Elbasan.</p>
        <?php endif; ?>
    </div>
