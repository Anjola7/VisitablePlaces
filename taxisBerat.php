...
// Merrni taksitë në Berat
$sql = "SELECT * FROM facilities WHERE type = 'taxi' AND city = 'Berat'";
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="taxiBerat.php">Taksitë</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Taksitë në Berat</h1>
        ...
        <?php else: ?>
            <p>Asnjë taksi nuk u gjet në Berat.</p>
        <?php endif; ?>
    </div>
