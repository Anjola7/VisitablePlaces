...
// Merrni hotelet në Shkodër
$sql = "SELECT * FROM facilities WHERE type = 'hotel' AND city = 'Shkoder'";
...
<head>
    ...
    <title>Hotelet në Shkodër</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Udhëzuesi për Shkodrën</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="barsShkoder.php">Bar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="hotelsShkoder.php">Hotelet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="restaurantsShkodra.php">Restorantet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="taxisShkoder.php">Taksitë</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Hotelet në Shkodër</h1>
                ...
                <div class="carousel-inner">
                    <?php foreach ($hotels as $index => $hotel): ?>
                        <div class="carousel-item <?php echo $index === 0 ? 'active' : ''; ?>">
                            <img src="<?php echo htmlspecialchars($hotel['photo']); ?>" class="d-block w-100" alt="<?php echo htmlspecialchars($hotel['name']); ?>" data-booking-url="<?php echo htmlspecialchars($hotel['booking_url']); ?>">
        ...
        <?php else: ?>
            <p>Asnjë hotel nuk u gjet në Shkodër.</p>
        <?php endif; ?>
    </div>
