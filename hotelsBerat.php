...
// Merrni hotelet në Berat
$sql = "SELECT * FROM facilities WHERE type = 'hotel' AND city = 'Berat'";
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Udhëzuesi për Beratin</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="barsBerat.php">Bar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="hotelsBerat.php">Hotelet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="restaurantsBerat.php">Restorantet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="taxisBerat.php">Taksitë</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Hotelet në Berat</h1>
        ...
        <?php else: ?>
            <p>Asnjë hotel nuk u gjet në Berat.</p>
        <?php endif; ?>
    </div>
