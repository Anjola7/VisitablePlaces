...
// Merrni taksitë në Shkodër
$sql = "SELECT * FROM facilities WHERE type = 'taxi' AND city = 'Shkoder'";
...
<head>
    ...
    <title>Taksitë në Shkodër</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="hotelsShkoder.php">Hotelet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="restaurantsShkoder.php">Restorantet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="taxishkoder.php">Taksitë</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Taksitë në Shkodër</h1>
        ...
        <?php else: ?>
            <p>Asnjë taksi nuk u gjet në Shkodër.</p>
        <?php endif; ?>
    </div>
