...
// Merrni restorantet në Vlorë
$sql = "SELECT * FROM facilities WHERE type = 'restaurant' AND city = 'Vlore'";
...
<head>
    ...
    <title>Restorantet në Vlorë</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="barsVlore.php">Bar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="hotelsVlore.php">Hotelet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="restaurantsVlore.php">Restorantet</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Restorantet në Vlorë</h1>
        ...
        <?php else: ?>
            <p>Asnjë restorant nuk u gjet në Vlorë.</p>
        <?php endif; ?>
    </div>
