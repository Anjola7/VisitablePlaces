...
// Merrni restorantet në Shkodër
$sql = "SELECT * FROM facilities WHERE type = 'restaurant' AND city = 'Shkoder'";
...
<head>
    ...
    <title>Restorantet në Shkodër</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="barsShkoder.php">Bar në Shkodër</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="hotelsShkodra.php">Hotelet në Shkodër</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="restaurantsShkoder.php">Restorantet në Shkodër</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="taxisShkoder.php">Taksitë në Shkodër</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Restorantet në Shkodër</h1>
        ...
        <?php else: ?>
            <p>Asnjë restorant nuk u gjet në Shkodër.</p>
        <?php endif; ?>
    </div>
