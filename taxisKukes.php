...
// Merrni taksitë në Kukës
$sql = "SELECT * FROM facilities WHERE type = 'taxi' AND city = 'Kukes'";
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="taxiKukes.php">Taksitë</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Taksitë në Kukës</h1>
        ...
        <?php else: ?>
            <p>Asnjë taksi nuk u gjet në Kukës.</p>
        <?php endif; ?>
    </div>
