...
// Merrni atraksionet në Gjirokastër
$sql = "SELECT * FROM locations WHERE location_city = 'Gjirokaster'";
...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="z-index: 1001;">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">Gjirokastra Explorer</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="locations_gjirokaster.php">Buy ticket</a>
                </li>
                <li class="nav-item">
...
<div class="sidebar">
    <h2>Explore Gjirokaster</h2>
    <a href="hotelsGjirokaster.php">Hotels</a>
    <a href="restaurantsGjirokaster.php">Restaurants</a>
    <a href="taxisGjirokaster.php">Taxis</a>
    <a href="barsGjirokaster.php">Bars</a>
</div>
    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade mt-5" data-bs-ride="carousel">
        <div class="carousel-inner">
            <?php if (!empty($attractions)): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p>Asnjë atraksion nuk u gjet në Gjirokastër.</p>
            <?php endif; ?>
        </div>
