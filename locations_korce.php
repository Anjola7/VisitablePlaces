...
// Marrja e të gjitha vendndodhjeve që janë të lidhura me Korçën
$query = "SELECT * FROM locations WHERE location_city = 'Korce'";
...
<head>
    ...
    <title>Locations in Korce</title>
