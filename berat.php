...
// Merrni atraksionet në Berat
$sql = "SELECT * FROM locations WHERE location_city = 'Berat'";
...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="z-index: 1001;">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">Berat Explorer</a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <?php include 'fetchberat_locations.php'; ?>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="locations_berat.php">Buy ticket</a>
                </li>
                <li class="nav-item">
...
<div class="sidebar">
    <h2>Explore Berat</h2>
    <a href="hotelsBerat.php">Hotels</a>
    <a href="restaurantsBerat.php">Restaurants</a>
    <a href="taxisBerat.php">Taxis</a>
    <a href="barsBerat.php">Bars</a>
</div>
    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade mt-5" data-bs-ride="carousel">
        <div class="carousel-inner">
            <?php if (!empty($attractions)): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p>Asnjë atraksion nuk u gjet në Berat.</p>
            <?php endif; ?>
        </div>
