...
// Merrni restorantet në Gjirokastër
$sql = "SELECT * FROM facilities WHERE type = 'restaurant' AND city = 'Gjirokaster'";
...
<head>
    ...
    <title>Restorantet në Gjirokastër</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Udhëzuesi për Gjirokastrën</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="restaurantsGjirokaster.php">Restorantet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="taxisGjirokaster.php">Taksitë</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Restorantet në Gjirokastër</h1>
        ...
        <?php else: ?>
            <p>Asnjë restorant nuk u gjet në Gjirokastër.</p>
        <?php endif; ?>
    </div>
