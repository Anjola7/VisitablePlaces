...
// Merrni atraksionet në Tiranë
$sql = "SELECT * FROM locations WHERE location_city = 'Tirane'";
...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="z-index: 1001;">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">Tirana Explorer</a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <?php include 'fetch_locations.php'; ?>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="locations_tirane.php">Ticket</a>
                </li>
                <li class="nav-item">
...
<div class="sidebar">
    <h2>Explore Tirana</h2>
    <a href="hotelsTirana.php">Hotels</a>
    <a href="restaurantsTirana.php">Restaurants</a>
    <a href="taxisTirana.php">Taxis</a>
    <a href="barsTirana.php">Bars</a>
</div>
    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade mt-5" data-bs-ride="carousel">
        <div class="carousel-inner">
            <?php if (!empty($attractions)): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p>Asnjë atraksion nuk u gjet në Tiranë.</p>
            <?php endif; ?>
        </div>
