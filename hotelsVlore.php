...
// Merrni hotelet në Vlorë
$sql = "SELECT * FROM facilities WHERE type = 'hotel' AND city = 'Vlore'";
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="hotelsVlore.php">Hotelet</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Hotelet në Vlorë</h1>
        ...
        <?php else: ?>
            <p>Asnjë hotel nuk u gjet në Vlorë.</p>
        <?php endif; ?>
    </div>
