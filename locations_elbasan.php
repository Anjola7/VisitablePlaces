...
// Marrja e të gjitha vendndodhjeve që janë të lidhura me Elbasanin
$query = "SELECT * FROM locations WHERE location_city = 'Elbasan'";
...
<head>
    ...
    <title>Locations in Elbasan</title>
