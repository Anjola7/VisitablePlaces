...
// Merrni taksitë në Tiranë
$sql = "SELECT * FROM facilities WHERE type = 'taxi' AND city = 'Gjirokaster'";
...
<head>
    ...
    <title>Taksitë në Gjirokaster</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Udhëzuesi për Gjirokastren</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="barsGjirokaster.php">Bar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="hotelsGjirokaster.php">Hotelet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="restaurantsGjirokaster.php">Restorantet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="taxisGjirokaster.php">Taksitë</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Taksitë në Gjirokaster</h1>
                ...
                <div class="carousel-inner">
                    <?php foreach ($taxis as $index => $taxi): ?>
                        <div class="carousel-item <?php echo $index === 0 ? 'active' : ''; ?>">
                            <img src="<?php echo htmlspecialchars($taxi['photo']); ?>" class="d-block w-100" alt="<?php echo htmlspecialchars($taxi['name']); ?>">
        ...
        <?php else: ?>
            <p>Asnjë taksi nuk u gjet në Gjirokaster.</p>
        <?php endif; ?>
    </div>
