...
// Merrni baret në Korçë
$sql = "SELECT * FROM facilities WHERE type = 'bar' AND city = 'Korce'";
...
<body>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Baret në Korçë</h1>
        ...
        <?php else: ?>
            <p>Asnjë bar nuk u gjet në Korçë.</p>
        <?php endif; ?>
    </div>
