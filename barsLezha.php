...
// Merrni baret në Lezhë
$sql = "SELECT * FROM facilities WHERE type = 'bar' AND city = 'Lezhe'";
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="barLezha.php">Bar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="hotelsLezha.php">Hotelet</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Baret në Lezhë</h1>
        ...
        <?php else: ?>
            <p>Asnjë bar nuk u gjet në Lezhë.</p>
        <?php endif; ?>
    </div>
