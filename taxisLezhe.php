...
// Merrni taksitë në Lezhë
$sql = "SELECT * FROM facilities WHERE type = 'taxi' AND city = 'Lezhe'";
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="barLezhe.php">Bar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="hotelsLezhe.php">Hotelet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="taxiLezhe.php">Taksitë</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="restaurantsLezhe.php">Restorantet</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Taksitë në Lezhë</h1>
        ...
        <?php else: ?>
            <p>Asnjë taksi nuk u gjet në Lezhë.</p>
        <?php endif; ?>
    </div>
