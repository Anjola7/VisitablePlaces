...
// Merrni hotelet në Dibrë
$sql = "SELECT * FROM facilities WHERE type = 'hotel' AND city = 'Diber'";
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="barsDiber.php">Bar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="hotelsDiber.php">Hotelet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="restaurantsDiber.php">Restorantet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="taxisDiber.php">Taksitë</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Hotelet në Dibrën</h1>
        ...
        <?php else: ?>
            <p>Asnjë hotel nuk u gjet në Dibrën.</p>
        <?php endif; ?>
    </div>
