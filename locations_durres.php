...
// Marrja e të gjitha vendndodhjeve që janë të lidhura me Durrësin
$query = "SELECT * FROM locations WHERE location_city = 'Durres'";
...
<head>
    ...
    <title>Locations in Durres</title>
