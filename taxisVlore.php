...
// Merrni taksitë në Vlorë
$sql = "SELECT * FROM facilities WHERE type = 'taxi' AND city = 'Vlore'";
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="barvlore.php">Bar</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="taxivlore.php">Taksitë</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Taksitë në Vlorë</h1>
        ...
        <?php else: ?>
            <p>Asnjë taksi nuk u gjet në Vlorë.</p>
        <?php endif; ?>
    </div>
