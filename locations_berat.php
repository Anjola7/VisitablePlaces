...
// Marrja e të gjitha vendndodhjeve që janë të lidhura me Beratin
$query = "SELECT * FROM locations WHERE location_city = 'Berat'";
...
<head>
    ...
    <title>Locations in Berat</title>
