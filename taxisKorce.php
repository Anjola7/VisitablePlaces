...
// Merrni taksitë në Korçë
$sql = "SELECT * FROM facilities WHERE type = 'taxi' AND city = 'Korce'";
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="hotelsKorce.php">Hotelet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="restaurantsKorce.php">Restorantet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="taxisKorce.php">Taksitë</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Taksitë në Korçë</h1>
        ...
        <?php else: ?>
            <p>Asnjë taksi nuk u gjet në Korçë.</p>
        <?php endif; ?>
    </div>
