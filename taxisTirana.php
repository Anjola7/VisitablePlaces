...
$sql = "SELECT * FROM facilities WHERE type = 'taxi' AND city = 'Tirane'";
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="taxitirana.php">Taksitë</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Taksitë në Tiranë</h1>
        ...
        <?php else: ?>
            <p>Asnjë taksi nuk u gjet në Tiranë.</p>
        <?php endif; ?>
    </div>
