...
// Merrni restorantet në Berat
$sql = "SELECT * FROM facilities WHERE type = 'restaurant' AND city = 'Berat'";
...
<head>
    ...
    <title>Restorantet në Berat</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="hotelsBerat.php">Hotelet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="restaurantsBerat.php">Restorantet</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Restorantet në Berat</h1>
        ...
        <?php else: ?>
            <p>Asnjë restorant nuk u gjet në Berat.</p>
        <?php endif; ?>
    </div>
