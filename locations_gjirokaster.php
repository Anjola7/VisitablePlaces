...
// Marrja e të gjitha vendndodhjeve që janë të lidhura me Gjirokastrën
$query = "SELECT * FROM locations WHERE location_city = 'Gjirokaster'";
...
<head>
    ...
    <title>Locations in Gjirokaster</title>
...
<body>
    ...
    <div class="container">
        <h1>Locations in Gjirokaster</h1>
