...
// Merrni atraksionet në Vlorë
$sql = "SELECT * FROM locations WHERE location_city = 'Vlore'";
...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="z-index: 1001;">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">Vlorë Explorer</a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <?php include 'fetch_vlore_locations.php'; // Përdorni skedarin për të tërhequr atraksionet e Vlorës ?>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="locations_vlore.php">Buy ticket</a>
                </li>
                <li class="nav-item">
...
<div class="sidebar">
    <h2>Explore Vlorë</h2>
    <a href="hotelsVlore.php">Hotels</a>
    <a href="restaurantsVlore.php">Restaurants</a>
    <a href="taxisVlore.php">Taxis</a>
    <a href="barsVlore.php">Bars</a>
</div>
    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade mt-5" data-bs-ride="carousel">
        <div class="carousel-inner">
            <?php if (!empty($attractions)): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p>Asnjë atraksion nuk u gjet në Vlorë.</p>
            <?php endif; ?>
        </div>
