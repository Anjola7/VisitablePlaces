...
// Merrni baret në Shkodër
$sql = "SELECT * FROM facilities WHERE type = 'bar' AND city = 'Shkoder'";
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="barShkodra.php">Bar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="hotelsShkodra.php">Hotelet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="restaurantsShkodra.php">Restorantet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="taxisShkodra.php">Taksitë</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Baret në Shkodër</h1>
        ...
        <?php else: ?>
            <p>Asnjë bar nuk u gjet në Shkodër.</p>
        <?php endif; ?>
    </div>
