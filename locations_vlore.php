...
// Marrja e të gjitha vendndodhjeve që janë të lidhura me Vlorën
$query = "SELECT * FROM locations WHERE location_city = 'Vlore'";
...
<head>
    ...
    <title>Locations in Vlorë</title>
