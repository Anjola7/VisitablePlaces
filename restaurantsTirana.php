...
// Merrni restorantet në Tiranë
$sql = "SELECT * FROM facilities WHERE type = 'restaurant' AND city = 'Tirane'";
...
<head>
    ...
    <title>Restorantet në Tiranë</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="bartirana.php">Bar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="hotelsTirana.php">Hotelet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="restaurantsTirana.php">Restorantet</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Restorantet në Tiranë</h1>
        ...
        <?php else: ?>
            <p>Asnjë restorant nuk u gjet në Tiranë.</p>
        <?php endif; ?>
    </div>
