...
// Merrni baret në Kukës
$sql = "SELECT * FROM facilities WHERE type = 'bar' AND city = 'Kukes'";
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="restaurantsKukes.php">Restorantet</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Baret në Kukës</h1>
        ...
        <?php else: ?>
            <p>Asnjë bar nuk u gjet në Kukës.</p>
        <?php endif; ?>
    </div>
