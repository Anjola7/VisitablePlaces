...
// Merrni restorantet në Fier
$sql = "SELECT * FROM facilities WHERE type = 'restaurant' AND city = 'Fier'";
...
<head>
    ...
    <title>Restorantet në Fier</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="restaurantsFier.php">Restorantet</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Restorantet në Fier</h1>
        ...
        <?php else: ?>
            <p>Asnjë restorant nuk u gjet në Fier.</p>
        <?php endif; ?>
    </div>
