...
// Marrja e të gjitha vendndodhjeve që janë të lidhura me Tiranën
$query = "SELECT * FROM locations WHERE location_city = 'Tirane'";
...
<head>
    ...
    <title>Locations in Tirana</title>
