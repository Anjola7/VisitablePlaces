...
// Merrni atraksionet në Dibrë
$sql = "SELECT * FROM locations WHERE location_city = 'Diber'";
...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="z-index: 1001;">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">Dibra Explorer</a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <?php include 'fetchdib_locations.php'; ?>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="locations_dibra.php">Buy ticket</a>
                </li>
                <li class="nav-item">
...
<div class="sidebar">
    <h2>Explore Dibra</h2>
    <a href="hotelsDibra.php">Hotels</a>
    <a href="restaurantsDibra.php">Restaurants</a>
    <a href="taxisDibra.php">Taxis</a>
    <a href="barsDibra.php">Bars</a>
</div>
    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade mt-5" data-bs-ride="carousel">
        <div class="carousel-inner">
            <?php if (!empty($attractions)): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p>Asnjë atraksion nuk u gjet në Dibër.</p>
            <?php endif; ?>
        </div>
